...
```{r}
mwd %>% ggplot(aes(x = State.Minimum.Wage)) + geom_histogram() + xlab("State Minimum Wage")
...
ggplot(wage.with.inflation, aes(x=Year, group=1)) + 
  geom_line(aes(y = m.wage, colour = "m.wage")) + 
  geom_line(aes(y = ExpectedWage, color = "Expected Wage"))



ggplot(wage.with.inflation, aes(x=Year, group=1)) + 
  geom_line(aes(y = fed.wage, colour = "fed.wage")) + 
  geom_line(aes(y = ExpectedWage, color = "Expected Wage"))
``` 
